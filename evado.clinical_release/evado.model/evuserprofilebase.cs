...
namespace Evado.Model
{
  ...
  public class EvUserProfileBase
  {
    ...
    public enum UserAuthenticationStates
    {
      ...
      /// <summary>
      /// This enumerated state indicates that the user credntials have been client side authenticated.
      /// </summary>
    ...
    /// </summary>
    public string ActiveDirectoryUserId { get; set; } = String.Empty;
    ...
    protected void setNames ( )
    {
      ...
      {
        this._CommonName = this.Prefix + " " + this.GivenName + " " + this._FamilyName;
        return;
      }

      this._CommonName = this.GivenName + " " + this.FamilyName;
    ...
    /// </summary>
    public EvEmailAddress EmailAddress { get; set; } = new EvEmailAddress ( );
    ...
    /// </summary>
    public DateTime ExpiryDate { get; set; } = Evado.Model.EvStatics.CONST_DATE_NULL;
    ...
    /// </summary>
    public string SignoffAction { get; set; } = String.Empty;
    ...
    /// </summary>
    public UserAuthenticationStates AuthenticationState { get; set; }
    ...
    /// </summary>
    public DateTime UpdatedDate { get; set; } = Evado.Model.EvStatics.CONST_DATE_NULL;
    ...
    /// <param name="Value">String: parameter value</param>
    //---------------------------------------------------------------------------------------
    public string setParameter ( object Name, EvDataTypes DataType, object Value )
    {
      EvObjectParameter parm = new EvObjectParameter (
        Name, DataType, Value );

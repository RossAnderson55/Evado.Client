...
namespace Evado.UniForm.Model
{
  ...
  /// This object is populated with page EuCommand and field data values.
  /// </summary>
  // ----------------------------------------------------------------------------------
  [Serializable]
  public class EuPageData
  {
    ...
    private EuEditAccess _Status = EuEditAccess.Inherited;
    ...
    public EuEditAccess EditAccess
    {
      get { return _Status; }
      set { _Status = value; }
    }
    ...
    private List<EuPageReference> _CommandList = new List<EuPageReference>( );


    /// <summary>
    /// This property contains the list of page EuCommands.
    /// The Parameter name field contains the EuCommand Identifier
    /// The parameter value field contains the PageData object guid identifer that is to be called by the EuCommand. 
    /// </summary>

    public List<EuPageReference> CmdList
    {
      get { return this._CommandList; }
      set { this._CommandList = value; }
    }

    private List<EuDataObj> _DataList = new List<EuDataObj>( );
    /// <summary>
    ...
    /// </summary>
    // ----------------------------------------------------------------------------------
    public List<EuDataObj> DataList
    {
    ...
    // ==================================================================================
    /// <summary>
    /// This method adds a EuCommand page reference object to the EuCommand reference list.
    /// </summary>
    /// <param name="PageReference">PageReference: Object referecing the EuCommand to be executed.</param>
    /// <remarks>
    /// This method consists of following steps. 
    /// 
    /// 1. Add the page reference object to the EuCommand list.
    /// 
    /// </remarks>
    // ----------------------------------------------------------------------------------
    public void addPageReference( EuPageReference PageReference )
    {
      // 
      // Add the page reference object to the EuCommand list
      // 
    ...
    /// This method adds a EuCommand page reference object to the EuCommand reference list.
    /// </summary>
    /// <param name="CommandGuid">Guid: Referecing the EuCommand to be executed.</param>
    ...
    /// 
    /// 2. Add the page reference object to the EuCommand list
    /// 
    /// 3. Return the page reference object.
    /// 
    /// </remarks>
    // ----------------------------------------------------------------------------------
    public EuPageReference addPageReference( Guid EuCommandGuid, Guid PageDataGuid )
    {
      // 
      // Initialise the page reference object with the method parameter values.
      // 
      EuPageReference pageReference = new EuPageReference( EuCommandGuid, PageDataGuid );

        ...
        <div id="form-body-dynamic-section" class="cf">
          ...
          <div id="PagedGroups" visible="false" runat="server">
            ...
            <table style='width: 100%;'>
              <tr>
                <td style='width: 50%;'>
                  <a id="btnPageLeft" class="LinkBackground btn btn-danger"
                    style="width: 100px" href="javascript:onChangeGroup('Back')"><< Previous </a>
                </td>
                <td style='width: 50%;'>
                  <a id="btnPageRight" class="LinkBackground btn btn-danger"
                    style="width: 100px; float: right;" href="javascript:onChangeGroup('Next')">Next >> </a>
                </td>
              </tr>
            </table>
          </div>
